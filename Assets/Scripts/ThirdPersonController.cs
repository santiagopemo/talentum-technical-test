...
namespace StarterAssets
{
	public class ThirdPersonController : MonoBehaviour
	{
		...
		private float _cameraSensitivuty = 430.0f;
		...
		{
			Vector2 look = new Vector2(Input.GetAxisRaw("Mouse X"), Input.GetAxisRaw("Mouse Y")) * _cameraSensitivuty;
		...
		private void Move()
		{
			...
			float inputMagnitude = false ? move.magnitude : 1f;
